...
WoT.expose({name: "TestThing" })
    .then(function (thing) {
        ...
        thing
            .addAction({name : "void-int", "outputDataDescription": { type: "integer" } } )
        ...
        thing
            .addAction({name : "int-void", "inputDataDescription": { type: "integer" } })
        ...
        thing
            .addAction({name : "int-int", "inputDataDescription": { type: "integer" }, "outputDataDescription": { type: "integer" } })
        ...
        thing
            .addAction({name : "int-string", "inputDataDescription": { type: "integer" }, "outputDataDescription": { type: "string" } })
